...
const BuiltWith = (props: BuiltWithProps) => {
  ...
  return hide ? (
    ...
    <div className="fixed bottom-0 end-0 z-[60] sm:max-w-sm w-auto mx-auto p-4">
      <div className="px-2 bg-white border border-primary-100 rounded-xl shadow-sm dark:bg-background dark:border-secondary">
        <div className="flex justify-between items-center">
          <div className=" pl-2 text-sm text-secondary dark:text-white mt- mr-2 font-bold">
            Made with
          </div>
